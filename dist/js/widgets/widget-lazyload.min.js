...
((r,l)=>{var o=r.tablesorter;o.lazyload={init:function(t,e){"scrollstop"!==e.lazyload_event||o.addScrollStopDone||(o.addScrollStop(),o.addScrollStopDone=!0,r.event.special.scrollstop.latency=e.lazyload_latency||250),o.lazyload.update(t,e);var a=t.namespace+"lazyload ",e=[e.lazyload_update,"pagerUpdate",e.columnSelector_updated||"columnUpdate",""].join(a);t.$table.on(e,function(){o.lazyload.update(t,t.widgetOptions)}).on("filterEnd"+a,function(){r(l).scroll()})},update:function(t,e){var a=(/(\.|#)/.test(e.lazyload_imageClass)?"":".")+e.lazyload_imageClass;t.$table.find(a).lazyload({threshold:e.lazyload_threshold,failure_limit:e.lazyload_failure_limit,event:e.lazyload_event,effect:e.lazyload_effect,container:e.lazyload_container,data_attribute:e.lazyload_data_attribute,skip_invisible:e.lazyload_skip_invisible,appear:e.lazyload_appear,load:e.lazyload_load,placeholder:e.lazyload_placeholder}),setTimeout(function(){r(l).scroll()},1)},remove:function(t){t.$table.off(t.namespace+"lazyload")}},o.addWidget({id:"lazyload",options:{lazyload_imageClass:"lazy",lazyload_update:"lazyloadUpdate",lazyload_latency:250,lazyload_threshold:0,lazyload_failure_limit:0,lazyload_event:"scrollstop",lazyload_effect:"show",lazyload_container:l,lazyload_data_attribute:"original",lazyload_skip_invisible:!0,lazyload_appear:null,lazyload_load:null,lazyload_placeholder:"data:image/gif;base64,R0lGODlhAQABAIABAP///wAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="},init:function(t,e,a,l){o.lazyload.init(a,l)},remove:function(t,e,a){o.lazyload.remove(e,a)}}),o.addScrollStop=function(){var n=r.event.dispatch||r.event.handle,i=r.event.special,o="D"+ +new Date,a="D"+(+new Date+1);i.scrollstart={setup:function(t){function e(t){var e=arguments;a?clearTimeout(a):(t.type="scrollstart",n.apply(this,e)),a=setTimeout(function(){a=null},l.latency)}var a,l=r.extend({latency:i.scrollstop.latency},t);r(this).bind("scroll",e).data(o,e)},teardown:function(){r(this).unbind("scroll",r(this).data(o))}},i.scrollstop={latency:250,setup:function(t){function e(t){var e=this,a=arguments;l&&clearTimeout(l),l=setTimeout(function(){l=null,t.type="scrollstop",n.apply(e,a)},o.latency)}var l,o=r.extend({latency:i.scrollstop.latency},t);r(this).bind("scroll",e).data(a,e)},teardown:function(){r(this).unbind("scroll",r(this).data(a))}}}})(jQuery,window),
/*!
