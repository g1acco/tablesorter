...
t.tablesorter.addParser({id:"globalize-date",is:function(){return!1},format:function(e,l,a,o){var r,l=l.config,o=l.globalize&&(l.globalize[o]||l.globalize)||{};return Globalize&&(r="object"==typeof o.Globalize?o.Globalize:Globalize(o.lang||"en"),o.Globalize||(o.Globalize=r)),(l=r&&r.dateParser?r.dateParser(o)(e):e&&new Date(e))instanceof Date&&isFinite(l)?l.getTime():e},type:"numeric"}),
