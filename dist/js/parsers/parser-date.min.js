...
e.tablesorter.addParser({id:"sugar",is:function(){return!1},format:function(e){var t=Date.create||Sugar.Date.create,t=t?t(e):e&&new Date(e);return t instanceof Date&&isFinite(t)?t.getTime():e},type:"numeric"}),
